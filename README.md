...
Funcionalidade Principal: O coração da aplicação é a Análise Comparativa (Lado A vs. Lado B), que permite comparar cenários de custo vs. preço de venda em tempo real.

Lógica de Cálculo: A fórmula central da aplicação é:
Doses = Total Cost / (Selling Price * (1 - Margin%))

Diferencial de Mercado: A ferramenta foca-se em análise de sensibilidade dinâmica, superando a estática dos modelos em Excel/folhas de cálculo comuns no setor.
